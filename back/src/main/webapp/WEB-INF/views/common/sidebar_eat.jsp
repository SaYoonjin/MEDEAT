...
<div class="sidebar-menu">
    ...
    <div class="sidebar-header" style="text-align:center; padding:25px 0 20px 0; border-bottom:1px solid #ddd;">
        ...
        <!-- 로고 -->
        <div onclick="location.href='/auth/dashboard_eat'" style="cursor:pointer;">
    ...
    <!-- ⭐ Medi-EAT 전용 메뉴 -->
    <div class="menu-top">
        <div class="menu-item" onclick="location.href='/auth/dashboard_eat'">대시보드</div>
        <div class="menu-item" onclick="location.href='/diet/list'">식단관리</div>
        <div class="menu-item" onclick="location.href='/challenge/list'">Challenge</div>
        <div class="menu-item" onclick="location.href='/community/list'">Community</div>
        <div class="menu-item" onclick="location.href='/mypage/myinfo?mode=EAT'">MyPage</div>
    </div>
