...
## DB Refactoring Highlights

- 복약 기록 날짜 기준 정비 및 복합 유니크 인덱스 적용
  - 복용 날짜 컬럼 추가, 기존 데이터 보정, NOT NULL 적용
  - 약 ID + 복용 날짜 + 복용 회차 기준 중복 저장 방지

- 복약 알림 시간 정규화
  - 쉼표 문자열 기반 시간 조회를 별도 테이블 구조로 전환
  - 문자열 함수 조회를 복용 시간 동등 비교 구조로 개선

- 추천 음식 조회 SQL 개선
  - 전체 랜덤 정렬 구조를 음식 ID 기준 임의 시작점 조회 방식으로 변경
  - 평균 응답시간 53.65% 감소
...
## 기능 명세서
<img width="1180" height="1320" alt="image" src="https://github.com/user-attachments/assets/63abdd52-9ddc-41db-ba97-97a64b78c14d" />
<img width="1187" height="1371" alt="image" src="https://github.com/user-attachments/assets/6587d8b1-25b6-4db6-b8b7-0c66fa6fe32d" />
<img width="1192" height="597" alt="image" src="https://github.com/user-attachments/assets/f086d04a-1603-4300-bb8a-99d7e8e8ae2a" />
